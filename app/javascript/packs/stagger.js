...
// import staggerVisualizerEl from './application.js';
// import * as myModule from './application.js';
...
setTimeout(function(){ alert("Hello"); }, 3000);
  ...
  // document.querySelector('.stagger-visualizer').appendChild(fragment);

  function waited() {

  if (staggerVisualizerEl != undefined) {
    console.log(true)
  }
